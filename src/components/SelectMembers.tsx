...
export default function SelectMembers(props: any) {
    ...
    const [funcaoSelectedOption, setFuncaoSelectedOption] =
        useState<FuncaoObject>({ selectedFuncao: null })
    const [membroSelectedOptions, setMembroSelectedOptions] =
        useState<MembroObject>({ selectedMembro: null })

    const [funcaoSelectedOption1, setFuncaoSelectedOption1] =
        useState<FuncaoObject>({ selectedFuncao: null })
    const [membroSelectedOptions1, setMembroSelectedOptions1] =
        useState<MembroObject>({ selectedMembro: null })

    const [funcaoSelectedOption2, setFuncaoSelectedOption2] =
        useState<FuncaoObject>({ selectedFuncao: null })
    const [membroSelectedOptions2, setMembroSelectedOptions2] =
        useState<MembroObject>({ selectedMembro: null })

    const [funcaoSelectedOption3, setFuncaoSelectedOption3] =
        useState<FuncaoObject>({ selectedFuncao: null })
    const [membroSelectedOptions3, setMembroSelectedOptions3] =
        useState<MembroObject>({ selectedMembro: null })

    const [funcaoSelectedOption4, setFuncaoSelectedOption4] =
        useState<FuncaoObject>({ selectedFuncao: null })
    const [membroSelectedOptions4, setMembroSelectedOptions4] =
        useState<MembroObject>({ selectedMembro: null })
    return (
        <>
            <Select
